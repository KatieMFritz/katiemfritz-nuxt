...
<nav class="m-nav u-center-text">
  <h3 class="m-nav__heading" id="contact">{{ heading }}</h3>
  <ul class="m-nav__list">
    <li v-for="link in links" class="m-nav__item">
      <a :href="link.url" class="a-icon--svg" :aria-label="link.description">
        <svg viewbox="0 0 512 512" role="img">
          <title>{{ link.description }}</title>
          <path :d="link.path"/>
        </svg>
        <!--[if lt IE 9]><em>{{ link.description }}</em><![endif]-->
      </a>
    </li>
  </ul><!--end m-nav__list-->
</nav><!--end m-nav-->
  ...
  data () {
    return {
      ...
      links: [
        {
          'description': 'Email',
          'url': 'mailto:katie@katiemfritz.com',
        ...
        {
          'description': 'Github',
          'url': 'https://github.com/KatieMFritz',
        ...
        },
        {
          ...
          'url': 'https://linkedin.com/in/KatieMFritz',
        ...
        },
        {
          ...
          'url': 'https://facebook.com/KatieMFritzLLC',
        ...
        {
          'description': 'Twitter',
          'url': 'https://twitter.com/KatieMaeFritz',
