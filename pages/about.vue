<template>
  <main role="main">
    <section class="l-container l-slice--l">
      ...
      <h2>I'm a geek.</h2>
      <p>Geek isn’t a bad word – it means I love to learn. These days, I mostly learn about project management, information architecture, user experience design, content strategy, taxes, and crochet (gotta have hobbies!). Earlier in my career, I’ve geeked nonprofit tech strategy, IT systems, association management, asset building policy, housing policy, and music. I still enjoy learning (and teaching) about all of those things.</p>

      <h2>I like people.</h2>
      <p>All of my projects put people at the center. Who visits your website? Why? How do they feel? What mortal humans have to maintain the site, and how can we make it easier? We’ll talk, a lot, and I’ll interview and observe as many people as I can to help make your website better.</p>
...
export default {
  ...
  data () {
    return {
      cta: 'Find out <a href="/services" title="Services">what we can do together</a>.'
    }
  },
  components: {
    'm-cta': mCta,
